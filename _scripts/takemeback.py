...
def getLastGitCommitDateIso8601Str():
	...
	gitlogLastDate = subprocess.Popen('git log -1 --format="%cI"', stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def MyMainProg():
	...
	newDateObj = lastDateObj + timedelta(minutes=timePassedMin, seconds=random.randrange(59) + 1)
